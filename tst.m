...
%b) Find the 95% confidence interval for the difference of average printing times
pkg load statistics
...
q=tinv(1-alpha/2,n) 
v1=x1bar-x2bar-q*sqrt(s1/n1+s2/n2)
v2=x1bar-x2bar+q*sqrt(s1/n1+s2/n2)
fprintf('b) Conf. interval for diff. of means, variances not equal (v1, v2) = (%4.3f, %4.3f)\n',v1, v2)
